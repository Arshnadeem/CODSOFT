...
*/	
	 ...
	 */
	public void MoneyTransfer(int amount, int pin, User fromUser, User toUser) {
	...
	public void checkAccount(User fromUser, User toUser) {
		...
		//if account no. is equal to to that no. then money can be transfered
		  ...
		  if(activeAcc==1)
		  {
			  ...
			  MoneyTransfer(amount, pin, fromUser, toUser);
		  }
		//transfer of money for 2nd user
		  else
		  {

			  MoneyTransfer(amount, pin, toUser, fromUser);
